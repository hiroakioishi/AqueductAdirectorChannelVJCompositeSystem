...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 67.0, 150.0, 20.0 ],
					"presentation_rect" : [ 141.0, 67.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "@github "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 67.0, 103.0, 20.0 ],
					"presentation_rect" : [ 15.0, 70.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 15.0, 63.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 13.0, 46.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 260.0, 121.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 114.0, 120.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "127.0.0.1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 251.0, 90.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Audio"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 450.0, 86.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "60"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 386.0, 89.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 326.5, 87.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 178.0, 442.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 115.5, 411.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 219.0, 477.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 19.0, 63.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Settings"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 230.0, 198.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Controller"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 12.0, 185.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Manager"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.292188, 0.836825, 0.833916, 1.0 ],
					"id" : "obj-6",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 0,
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/teamLab/github/AqueductAdirectorChannelVJCompositeSystem/Controller/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "switchScene.js",
				"bootpath" : "~/Documents/teamLab/github/AqueductDollhouseVJController/AqueductDollHouseVJController/code",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
